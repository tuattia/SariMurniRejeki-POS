...
public class utangcontroller {
    ...
    public List<modelutang> tampil() {
        ...
        String sql = "SELECT kode_utang, nama, alamat, telepon, harga_brng, dp, jumlah_cicilan, jatuh_tempo, kode_barang " +
        ...
        try (PreparedStatement ps = con.prepareStatement(sql);
            ...
            while (rs.next()) {
                ...
                mu.setKodeBarang(rs.getString("kode_barang"));
...
public int tambahUtang(modelutang e) {
    ...
    String sql = "INSERT INTO utang "
            + "(kode_utang, nama, alamat, telepon, harga_brng, dp, jumlah_cicilan, jatuh_tempo, status, kode_transaksi,kode_barang) "
            + "VALUES (?,?,?,?,?,?,?,?,?,?)";
    ...
    try (PreparedStatement ps = con.prepareStatement(sql)) {
        ...
        ps.setString(11, e.getKodeBarang());
