...
public class crudUtang extends javax.swing.JFrame {
    ...
    barangcontroller ub = new barangcontroller();
...
//        d.setNamaBarang(tblkredit.getValueAt(i, 1).toString());
    ...
    for (modelutang mu : ListUtang) {
        ...
        data[7] = mu.getJatuhTempo().format(formatter); // LocalDate → String
        data[8] = mu.getKodeBarang();
...
private void startClock() {
    ...
    private final String PLACEHOLDER_TGL = "Contoh : 31-01-2026";
    ...
    private void initComponents() {
        ...
        sidepanel.add(utangbutton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 520, 270, -1));
        ...
        sidepanel.add(utangbutton, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 470, 270, 50));
        ...
        jLabel18.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icon/logosmrhitam-removebg-preview 1.png"))); // NOI18N
        sidepanel.add(jLabel18, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 20, -1, -1));
        ...
        jLabel9.setText("Tanggal  Kredit");
        ...
        txtJt.setText("Contoh : 31-01-2026");
        ...
        layout.setVerticalGroup(
            layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(sidepanel, javax.swing.GroupLayout.DEFAULT_SIZE, 880, Short.MAX_VALUE)
    ...
    try{
        ...
        LocalDate jatuhTempo = LocalDate.parse(txtJt.getText(), formatter);
        ...
        String namabarang = tblkredit.getValueAt(row, 0).toString();
        u.setKodeBarang(namabarang);
    ...
    modelbarang mb = ub.getByKode(mu.getKodeBarang());
