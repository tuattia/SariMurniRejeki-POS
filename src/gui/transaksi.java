...
private void tampilnama() {
    ...
    try {
        ...
        for (modeltd detail : detailList) {
        boolean stokTersedia = bc.kurangiStok(detail.getKodeBarang(), detail.getQty()); 
        
        if (!stokTersedia) {
            JOptionPane.showMessageDialog(this, 
                "Transaksi GAGAL! Stok barang tidak mencukupi.");
            return; // BERHENTI DI SINI, jangan lanjut ke proses simpan
        }
    }
        // ================= TRANSAKSI =================
