...
public class detailutang extends javax.swing.JFrame {
    ...
    this.mb = bc.getByKode(mu.getKodeBarang());

    setUkuranFrame15x20();
    setBayarPerbulan();  
    System.out.println("DEBUG detailutang kode_barang = " + mu.getKodeBarang());
System.out.println("DEBUG detailutang mb = " + this.mb);
    loadHeader(mu, this.mb);
    loadTableCicilan(mu);
...
private void loadHeader(modelutang mu, modelbarang mb) {
    ...
    lblnamabarang.setText(mb.getNamaBarang());

    lbljumlahcicilan.setText(String.valueOf(mu.getJumlahcicilan()) + "x");
    lbltanggal.setText(
    mu.getJatuhTempo().format(
...
private void print15x20() {
    ...
    if (job.printDialog()) {
        ...
        // 2. TAMPILKAN KEMBALI TOMBOL SETELAH SELESAI
    ...
    private void initComponents() {
        ...
        panelDetailutang.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 90, -1, -1));

        jLabel3.setFont(new java.awt.Font("Poppins", 0, 12)); // NOI18N
        jLabel3.setText("Nama             :");
        panelDetailutang.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 130, -1, -1));

        jLabel4.setFont(new java.awt.Font("Poppins", 0, 12)); // NOI18N
        jLabel4.setText("Telepon          :");
        panelDetailutang.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 170, -1, -1));

        jLabel5.setFont(new java.awt.Font("Poppins", 0, 12)); // NOI18N
        jLabel5.setText("Alamat           :");
        panelDetailutang.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 150, -1, -1));

        jLabel6.setFont(new java.awt.Font("Poppins", 0, 12)); // NOI18N
        jLabel6.setText("Dp                  :");
        panelDetailutang.add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 150, -1, -1));

        jLabel7.setFont(new java.awt.Font("Poppins", 0, 12)); // NOI18N
        jLabel7.setText("Harga Barang :");
        panelDetailutang.add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 110, -1, -1));

        lblKodeUtang.setFont(new java.awt.Font("Poppins", 0, 12)); // NOI18N
        lblKodeUtang.setText("jLabel10");
        panelDetailutang.add(lblKodeUtang, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 90, -1, -1));

        lblNama.setFont(new java.awt.Font("Poppins", 0, 12)); // NOI18N
        lblNama.setText("jLabel10");
        panelDetailutang.add(lblNama, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 130, -1, -1));

        lblTelepon.setFont(new java.awt.Font("Poppins", 0, 12)); // NOI18N
        lblTelepon.setText("jLabel10");
        panelDetailutang.add(lblTelepon, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 170, -1, -1));

        lblAlamat.setFont(new java.awt.Font("Poppins", 0, 12)); // NOI18N
        lblAlamat.setText("jLabel10");
        panelDetailutang.add(lblAlamat, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 150, -1, -1));

        lblDP.setFont(new java.awt.Font("Poppins", 0, 12)); // NOI18N
        lblDP.setText("jLabel10");
        panelDetailutang.add(lblDP, new org.netbeans.lib.awtextra.AbsoluteConstraints(480, 150, -1, -1));

        lblHarga.setFont(new java.awt.Font("Poppins", 0, 12)); // NOI18N
        lblHarga.setText("jLabel10");
        panelDetailutang.add(lblHarga, new org.netbeans.lib.awtextra.AbsoluteConstraints(480, 110, -1, -1));
        ...
        panelDetailutang.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 230, 600, 270));

        jButton3.setText("Kembali");
        jButton3.addActionListener(this::jButton3ActionPerformed);
        panelDetailutang.add(jButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 610, -1, -1));

        jButton4.setText("Print");
        jButton4.addActionListener(this::jButton4ActionPerformed);
        panelDetailutang.add(jButton4, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 610, -1, -1));

        jLabel1.setFont(new java.awt.Font("Poppins", 0, 18)); // NOI18N
        jLabel1.setText("KARTU ANGSURAN");
        panelDetailutang.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 10, -1, -1));

        jLabel8.setFont(new java.awt.Font("Poppins", 0, 20)); // NOI18N
        jLabel8.setText("SARI MURNI REJEKI");
        panelDetailutang.add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 40, -1, -1));

        txtperbulan.setFont(new java.awt.Font("Poppins", 0, 12)); // NOI18N
        txtperbulan.setText("jLabel10");
        panelDetailutang.add(txtperbulan, new org.netbeans.lib.awtextra.AbsoluteConstraints(480, 170, -1, -1));

        jLabel9.setFont(new java.awt.Font("Poppins", 0, 12)); // NOI18N
        jLabel9.setText("Bayar Perbulan:");
        panelDetailutang.add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 170, -1, -1));

        jLabel10.setText("Pengawas");
        panelDetailutang.add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 510, -1, -1));

        jLabel11.setText("Peminjam");
        panelDetailutang.add(jLabel11, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 510, -1, -1));

        jLabel12.setText("(Ni Wayan Suerni)");
        panelDetailutang.add(jLabel12, new org.netbeans.lib.awtextra.AbsoluteConstraints(480, 590, -1, -1));

        jLabel13.setText("(.....................................................)");
        panelDetailutang.add(jLabel13, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 580, -1, -1));

        jLabel14.setFont(new java.awt.Font("Poppins", 0, 12)); // NOI18N
        jLabel14.setText("Nama Barang :");
        panelDetailutang.add(jLabel14, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 90, -1, -1));

        lblnamabarang.setFont(new java.awt.Font("Poppins", 0, 12)); // NOI18N
        lblnamabarang.setText("jLabel10");
        panelDetailutang.add(lblnamabarang, new org.netbeans.lib.awtextra.AbsoluteConstraints(480, 90, -1, -1));

        jLabel15.setFont(new java.awt.Font("Poppins", 0, 12)); // NOI18N
        jLabel15.setText("Jumlah  Cicilan :");
        panelDetailutang.add(jLabel15, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 130, -1, -1));

        lbljumlahcicilan.setFont(new java.awt.Font("Poppins", 0, 12)); // NOI18N
        lbljumlahcicilan.setText("jLabel10");
        panelDetailutang.add(lbljumlahcicilan, new org.netbeans.lib.awtextra.AbsoluteConstraints(480, 130, -1, -1));

        jLabel16.setFont(new java.awt.Font("Poppins", 0, 12)); // NOI18N
        jLabel16.setText("Tanggal            :");
        panelDetailutang.add(jLabel16, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 110, -1, -1));

        lbltanggal.setFont(new java.awt.Font("Poppins", 0, 12)); // NOI18N
        lbltanggal.setText("jLabel10");
        panelDetailutang.add(lbltanggal, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 110, -1, -1));

        javax.swing.GroupLayout layout = new javax.swing.GroupLayout(getContentPane());
        getContentPane().setLayout(layout);
        layout.setHorizontalGroup(
            layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(panelDetailutang, javax.swing.GroupLayout.DEFAULT_SIZE, 661, Short.MAX_VALUE)
        );
