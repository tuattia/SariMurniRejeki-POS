...
public class stock extends javax.swing.JFrame {
    ...
    snapshotcontroller sc = new snapshotcontroller();
...
public stock() {
    ...
    this.nama = nama;
    tampilnama();
    tambahTombolSnapshot();  // [BARU] Tambah tombol Snapshot ke form
}
...
private void loadTable() {
    ...
    private void initComponents() {
        ...
        getContentPane().add(sidepanel, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 270, 810));
...
// ================================================================
// [BARU] TAB SNAPSHOT BULANAN
// ================================================================
// [BARU] TOMBOL SNAPSHOT di sidepanel navigasi
// sidepanel memakai AbsoluteLayout -> AbsoluteConstraints BEKERJA.
// Diposisikan di bawah tombol LogOut (y=590+30=620).
// ================================================================
private void tambahTombolSnapshot() {
    JPanel btnPanel = new JPanel(new BorderLayout());
    btnPanel.setBackground(new Color(23, 118, 211));
    btnPanel.setBorder(BorderFactory.createBevelBorder(javax.swing.border.BevelBorder.RAISED));
    btnPanel.setCursor(new Cursor(Cursor.HAND_CURSOR));

    JLabel lbl = new JLabel("Snapshot Stok");
    lbl.setFont(new Font("Poppins", Font.PLAIN, 18));
    ...
    btnPanel.addMouseListener(new java.awt.event.MouseAdapter() {
        ...
        public void mouseClicked(java.awt.event.MouseEvent e) {
            snapshotDialog dialog = new snapshotDialog(
                    (java.awt.Frame) SwingUtilities.getWindowAncestor(btnPanel), true);
            dialog.setVisible(true);
        }
        @Override
        public void mouseEntered(java.awt.event.MouseEvent e) {
            btnPanel.setBackground(new Color(10, 90, 180));
        }
        @Override
    ...
    // Tambahkan ke sidepanel (AbsoluteLayout, lebar 270px)
    // LogOut ada di y=590, tinggi 30 -> tombol snapshot mulai y=625
    sidepanel.add(btnPanel,
            new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 625, 270, 50));
